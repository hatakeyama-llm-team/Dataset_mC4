...
base_path = "/data/satori_hdd4/takumi/steve_ssd2/matsuo_llm/JapaneseWarcParser/mc4s/src/cleaner/hoji_dict/"
cleaner = Compose([
    document_filters.JSONLoader(key="text"),
    document_filters.AcceptJapanese(),
    document_filters.DiscardRareKuten(),
    document_filters.DocumentLengthFilter(min_doc_len=100, max_doc_len=200000),
